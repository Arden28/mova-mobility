            ...
            <div className="row">
                ...
                <div className="row">
                  <div className="col-lg-11"><span className="hero-subtitle text-uppercase" data-aos="fade-up" data-aos-delay="0">Móva Mobility</span>
                    ...
                    <div className=" d-flex gap-2 mb-4 mb-lg-5" data-aos="fade-up" data-aos-delay="300">
                      <a className="btn btn-primary rounded-5" href="tel:+33612345678">Je réserve mon bus</a>
              ...
              <div className="col-lg-3">
                <div className="hero-img">
                  <img className="img-main rounded-4" src="/assets/images/hero.png" width="700px" alt="Hero Image" data-aos="fade-in" data-aos-delay="500" /></div>
              </div>
            </div>
          </div>
           {/* End Hero */}
